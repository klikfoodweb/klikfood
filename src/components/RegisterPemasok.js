			          ...
			          <div className="row">
			            <div className="col-sm-12">
			              <div className="signup-form">{/*sign up form*/}
			            	...
			            	<br/>
			            	<b>*Untuk mengajukan barang, silahkan Login dan masuk ke dashboard akun yang sudah didaftarkan.  </b>
			            	<br/>
			            	<br/>
			            	<p>Dengan Mengisi Formulir Ini Saya Menyatakan :</p>
		                      ...
		                      <br />
			                  <input form="distance_form" type="checkbox" required style={{position: 'relative'}} />Bahwa saya sepakat dan bersedia mengikuti aturan perusahaan tentang menjadi Pemasok.
							  <br />
