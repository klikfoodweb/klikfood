...
class SearchByKategori extends Component {
	...
	componentDidMount() {
		...
		axios.get(`https://api.klikfood.id/index.php/mitra/produk?verify=1&kategori=`+this.props.match.params.kategori, { 'headers': { 'Authorization': sessionStorage.api_token } })
	      .then((response) => {
