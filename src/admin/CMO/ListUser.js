...
class ListUser extends Component {
	...
	componentDidMount() {
		axios.get(`https://api.klikfood.id/index.php/listuser/konsumen`, { 'headers': { 'Authorization': sessionStorage.api_token } })
		  .then((response) => {
				      ...
				      <div className="body">
    			        <div className="table-responsive">
    			        	<BootstrapTable data={this.state.users} striped search pagination hover>
				        	  ...
				        	  <TableHeaderColumn dataField='point' dataSort={true}>Point</TableHeaderColumn>
