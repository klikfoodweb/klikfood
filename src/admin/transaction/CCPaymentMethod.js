...
class CCPaymentMethod extends Component {
	constructor(props) {
	    super(props);
	...
	componentWillMount() {
		...
		axios.get(`https://api.klikfood.id/MCP/CC/`+this.props.match.params.id, { 'headers': { 'Authorization': sessionStorage.api_token } })
      	  .then(response => {
