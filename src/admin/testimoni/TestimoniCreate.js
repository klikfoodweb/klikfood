...
class SliderCreate extends Component {
	...
	handleSubmit = (event) => {
		...
		axios.post(`https://api.klikfood.id/index.php/testimoni/store`, bodyFormData)
	      .then(response => {
	      	this.setState({
				submitting: true
			})
	      	toast.success("Menambah Testimoni Sukses !");
	      	setTimeout(() => {
	      	...
	      	toast.error("Tidak Bisa Menambah Testimoni :( ");
	      });
	}
